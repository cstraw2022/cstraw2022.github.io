...
import Swipe from "../assets/swipe2.mp4"
import NewKanji from "../assets/newkanji2.mp4"
import DetailTap from "../assets/detailtap2.mp4"
...
export function Personal() {
    ...
    return (
        <div id="Personal" style={{ minHeight: '1000px' }}>
            ...
            <table >
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style={{lineHeight:"28px"}}>If you feel the kanji of the current day isn't useful, whether you've learned it in the past etc., you can tap the button on the left to reshuffle. You can add as many cards as you want to the deck, and it won't discard the prior 14 days until midnight.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <p style={{lineHeight:"28px"}}>When tapping on a card, it brings up a more detailed view, containing various words that contain the kanji as well as a plethora of example sentences, all paired with English translations. (data from Tatoeba)</p>
                    </td>
                </tr>
                ...
                <td>
                    ...
                    <td>
                        ...
                        <p style={{lineHeight:"28px"}}>Arguably the most useful part of the app for passive learning. It shows the kanji that&#39;s at the top of the deck, which updates at midnight every night. With this, the app doesn&#39;t need to be opened for you to slowly learn kanji, both conciously and subconciously, while going through your week.</p>
                    </td>
            ...
            <h3>Description</h3>
            <p>Pokemon Showdown is a great way to enjoy Pokemon battles both with friends and competitively on your computer. While you can easily access the site on your mobile device, the navigation experience is less than ideal. This gave me the idea of developing a mobile client from the ground up in React Native. I felt that building this app would be a fun little project that improves the battling experience on the go, and also would help me brush up my knowledge of react.</p>
            <h3>Login Protocol</h3>
            <p>Showdown has a two factor authentication that requires an assertion key being requested from the server’s action.php. The implementation I used (All contained within LoginScreen.tsx) goes as follows:</p>
            ...
            <ol>
                ...
                <li style={{ paddingBottom: '20px' }}>After the user enters their username (and optionally password) and taps login, the event is handled in one of two ways:
                    <ol>
                    <li style={{ paddingTop: '10px' }}>If the user did not enter a password, an HTTP <code>POST</code>  request is sent to action.php with the act <code>'getassertion'</code> , the username and <code>challstr</code> . (only works on unregistered usernames)</li>
                    <li style={{ paddingTop: '10px' }}>If the user entered a password, an HTTP <code>POST</code> request is sent to action.php with the act <code>'login'</code>, and the username, password and <code>challstr</code> </li>
                    </ol>
                </li>
